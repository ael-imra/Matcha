...
const Body = (props) => {
  ...
  React.useEffect(() => {
    if (ctx.ErrorMessages.error !== "" || ctx.ErrorMessages.warning !== "" || ctx.ErrorMessages.success !== "") changeShowMessage(true);
    else changeShowMessage(false);
  }, [ctx.ErrorMessages.error, ctx.ErrorMessages.warning, ctx.ErrorMessages.success]);
          ...
          <Route exact path="/">
            <>
              <TransitionGroup
                ...
                style={{
                  height:
                    props.dataHome.StateHome === 1 || props.dataHome.StateHome === 4
                      ? "360px"
              ...
              >
                <CSSTransition key={props.dataHome.StateHome} timeout={800} classNames="alert" unmountOnExit>
