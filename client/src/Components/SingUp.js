      ...
      <div className='form-sing'>
        <div className='inline-group'>
          <div className='form-group'>
            ...
            <Input SizeGrow={1} type='text' name='Name' checkError={{ findError, ChangeError }} Ref={inputRef} index={0} />
          </div>
          <div className='form-group'>
            <p
              style={{
            ...
            <Input SizeGrow={1} type='text' name='Name' checkError={{ findError, ChangeError }} Ref={inputRef} index={1} />
          </div>
        </div>
        <div className='inline-group'>
          <div className='form-group'>
            ...
            <Input SizeGrow={1} type='text' name='Username' checkError={{ findError, ChangeError }} Ref={inputRef} index={2} />
          </div>
          <div className='form-group'>
            <p
              style={{
            ...
            <Input SizeGrow={1} type='password' name='Password' checkError={{ findError, ChangeError }} Ref={inputRef} index={3} />
          </div>
        </div>
        <div className='form-group' style={{ width: '100%' }}>
          ...
          <Input SizeGrow={2} type='email' name='Email' checkError={{ findError, ChangeError }} Ref={inputRef} index={4} />
        </div>
        <button
          onClick={() => {
            let i = 0;
