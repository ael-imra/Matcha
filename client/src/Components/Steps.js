    ...
    return (
      <>
        <div
          ...
          style={{
            backgroundColor:
              props.index <= props.NrStep ? '#03a9f1' : '#C4C4C4',
        ...
        <div
          ...
          style={{
            backgroundColor:
              props.index <= props.NrStep - 1 ? '#03a9f1' : '#C4C4C4',
            color: props.index <= props.NrStep ? '#dee5fc' : '#373e4e',
          }}
        ></div>
      </>
...
const Step = (props) => {
  ...
  let completeInsertUsers = () => {
    try {
      Axios.post(`http://localhost:5000/users/completeInsert`, {
        ...infoStep,
        token,
      })
        .then((result) => {
            ...
            <Button
              ...
              onClick={() => {
                if (NbrStep + 1 !== 7) {
                  ...
                  if (NbrStep === 2)
                    if (
                      infoStep.step4.DescribeYourself !== '' &&
                      infoStep.step4.yourInterest[0] !== ''
                    )
                  ...
                  if (NbrStep === 3) {
                    if (
                      infoStep.step3.youGender !== '' &&
                      infoStep.step3.genderYouAreLooking[0] !== ''
                    )
                      changeNrbStep(NbrStep + 1)
                    else
                      ctx.ChangeErrorMessages({
                  ...
                  if (NbrStep === 4) {
                    ...
                    if (
                      infoStep.step5.length >= 1 &&
                      findImageDefault(infoStep.step5)
                    ) {
                      completeInsertUsers()
                    } else
                      ctx.ChangeErrorMessages({
