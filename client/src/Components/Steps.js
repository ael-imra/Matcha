              ...
              onClick={() => {
                ...
                if (NbrStep === 2)
                  if (
                    ...
                    infoStep.step4.yourInterest.length <= 5 &&
                    infoStep.step4.yourInterest.length !== 0 &&
                    infoStep.step4.DescribeYourself.length <= 100 &&
                    infoStep.step4.yourInterest.every((Interest) => Interest.length >= 2 && Interest.length <= 25)
                  )
