  ...
  return (
    <div>
      ...
      <div className='Switch-btn'>
        ...
        <button className={`${props.InfoStep.step3.youGender === 'Woman' ? 'ft_btn-3 AnimationBtn' : 'ft_btn-2'}`} onClick={btnActives}>
          Woman
        </button>
      </div>
      <p
      ...
      <div className='choose-btn'>
        <button className={`${props.InfoStep.step3.genderYouAreLooking[1] === 'Male' || props.InfoStep.step3.genderYouAreLooking[0] === 'Male' ? 'ft_btn-3 AnimationBtn' : 'ft_btn-2'}`} onClick={ActivesBtn}>
          Male
        </button>
        <button className={`${props.InfoStep.step3.genderYouAreLooking[1] === 'Woman' || props.InfoStep.step3.genderYouAreLooking[0] === 'Woman' ? 'ft_btn-3 AnimationBtn' : 'ft_btn-2'}`} onClick={ActivesBtn}>
          Woman
        </button>
      </div>
    </div>
