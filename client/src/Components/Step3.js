  ...
  return (
    <>
      ...
      <div className="choose-btn">
        ...
        <button className={`${props.InfoStep.step3.genderYouAreLooking[1] === 'Female' || props.InfoStep.step3.genderYouAreLooking[0] === 'Female' ? 'ft_btn-3 AnimationBtn' : 'ft_btn-2'}`} onClick={ActivesBtn}>
          Female
        </button>
      </div>
    </>
