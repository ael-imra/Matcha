...
const Step3 = (props) => {
  ...
  let ActivesBtn = (e) => {
    e.target.classList.value =
      e.target.classList.value === 'ft_btn-2' ? 'ft_btn-3' : 'ft_btn-2'
    let DataStep3 = props.InfoStep
    let val = ''
    Array.from(document.querySelectorAll('.choose-btn .ft_btn-3')).forEach(
      (value) => {
  ...
  return (
    <div>
      ...
      <div className="Switch-btn">
        <button
          className={`${
            props.InfoStep.step3.youGender === 'Male'
              ? 'ft_btn-3 AnimationBtn'
              : 'ft_btn-2'
          }`}
          onClick={btnActives}
        >
        ...
        <button
          className={`${
            props.InfoStep.step3.youGender === 'Woman'
              ? 'ft_btn-3 AnimationBtn'
              : 'ft_btn-2'
          }`}
          onClick={btnActives}
      ...
      <div className="choose-btn">
        <button
          className={`${
            props.InfoStep.step3.genderYouAreLooking[1] === 'Male' ||
            props.InfoStep.step3.genderYouAreLooking[0] === 'Male'
              ? 'ft_btn-3 AnimationBtn'
              : 'ft_btn-2'
          }`}
          onClick={ActivesBtn}
        ...
        <button
          className={`${
            props.InfoStep.step3.genderYouAreLooking[1] === 'Woman' ||
            props.InfoStep.step3.genderYouAreLooking[0] === 'Woman'
              ? 'ft_btn-3 AnimationBtn'
              : 'ft_btn-2'
          }`}
          onClick={ActivesBtn}
